/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-credentials-claude-code`.
 * @module @deepseek-ai/dsh-credentials-claude-code/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-credentials-claude-code'

/** Cordis companion plugin name. */
export const name = 'credentials-claude-code-invariant'
